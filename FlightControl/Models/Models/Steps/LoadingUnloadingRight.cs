...
{
    public class LoadingUnloadingRight : BasicStep
    {
        private static readonly SemaphoreSlim _asyncLock = new SemaphoreSlim(1, 1);
        public static int FlightCount { get; set; }

        public LoadingUnloadingRight(int boardingLenght) : base(boardingLenght,
                                                                1,
                                                                1,
                                                                PlaneTerminalState.Вisembarking_Boarding_Passengers_7)
        {
            FlightCount = 0;
        }
